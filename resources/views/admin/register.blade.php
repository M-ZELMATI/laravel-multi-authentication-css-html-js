...
<body>
    <div class="container register">
        ...
        <form method="POST"  action="{{ route('admin.register') }}" id='upload_form'  enctype="multipart/form-data">
        <!-- action="{{ route('login') }}"  -->
            @csrf
        ...
        <button  name="upload" id="uploadadminregister"  data-token="{{ csrf_token() }}"  >Sign up</button>
        <p class="join-link">
            You have accont?
