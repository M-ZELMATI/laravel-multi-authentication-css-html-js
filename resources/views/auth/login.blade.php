...
<body>
    <div class="container">
        ...
        <form method="POST" action="{{ route('login') }}" id='upload_form'  enctype="multipart/form-data">
        <!-- action="{{ route('login') }}"  -->
            @csrf
        <div class="your-input">
            ...
            <a href="/login/user/forgetpassword" class="forgot-password-link">
            Forgot Password?
        </a>
        </div>
         <!-- error password -->
        ...
        <button  name="upload" id="uploaduserlogin"  data-token="{{ csrf_token() }}"  >Sign in</button>
        <p class="join-link">
            New to linkedin?
